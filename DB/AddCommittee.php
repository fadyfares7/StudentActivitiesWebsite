...
<div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		  ...
		  <h2 class="sub-header">Add Committee</h2>
          	<?php
			//handle input
			...
			?>
              <div class="panel panel-default col-sm-12" id="rcorners1">
                ...
                <input type="hidden" name="portal" value="add_committee"/>
                ...
                <button type="submit" class="btn btn-warning pull-right">Add Committee</button>
              </form>
